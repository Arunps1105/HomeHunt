    ...
    return (
        <div className={Styles.logincontainer}>
            <div className={Styles.loginBox}>
                ...
                {/* Fixed input fields - using div instead of table elements */}
                ...
                <div className={Styles.options}>
                  ...
                  <a onClick={() => navigate("/User/ForgotPassword")} style={{cursor:"pointer"}}>
    Forgot Password?
</a>
                </div>
                ...
                <button
                    className={`${Styles.registerBtn} ${Styles.createAccountBtn}`}
                    onClick={() => navigate("/guest/Registeration")}
                >
                    Create Account
                </button>
            </div>
